...
1. Unzip and move the `apply-with-linkedin` folder to your `/wp-content/plugins/` directory
...
Please visit the developer section on LinkedIn: https://www.linkedin.com/secure/developer
